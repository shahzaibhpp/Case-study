...
useHead({
  title: 'Bon Bon NYC – Client Success Story | Half Price Packaging',
  meta: [
    {
      name: 'description',
      content: 'How Half Price Packaging helped Bon Bon NYC create custom, sustainable packaging for their Swedish candy brand.'
    },
